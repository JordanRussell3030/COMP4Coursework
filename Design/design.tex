...
1.01 & To test the student log in button on the first menu functions as intended & This should link to the student menu screen & Click the log in button & Normal & The student account screen should be displayed & & \\ \hline
1.02 & To test the teacher log in button on the first menu functions as intended & This should link to the administrator menu screen & Click the log in button & Normal & The administrator account screen should be displayed & & \\ \hline
1.03 & To test the lessons button on the student account screen functions as intended & This should link to the lesson topic menu screen & Click the lessons button & Normal & The topic's lesson menu should be displayed & & \\ \hline
1.04 & To test the homework button on the student account screen functions as intended & This should link to the homework topic menu screen & Click the homework button & Normal & The topic's homework menu should be displayed & & \\ \hline
1.05 & To test the progress button on the student account screen functions as intended & This should link to the student's personal database display screen & Click the progress button & Normal & The student's personal database screen should be displayed & & \\ \hline
1.06 & To test the log out button on the student account screen functions as intended & This should close down the entire program & Click the log out button & Normal & The program should stop & & \\ \hline
1.07 & Trig 1
1.08 & Trig 2
1.09 & Pythag
1.10 & Pythag and trig
1.11 & Summary
1.12 & Lesson topic menu return
1.13 & Trig 1 sides aho button
1.14 & Trig 1 SOHCAHTOA button
1.15 & Trig 1 return button
1.16 & Trig 2 Finding angles button
1.17 & Trig 2 Inverted angles button
1.18 & Trig 2 3D Trig
1.19 & Trig 2 return button
    \end{longtable}
\end{center}
\end{landscape}