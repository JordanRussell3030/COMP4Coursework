...
\begin{center}
	...
	4 & Test all of hte mathematical algorithms to make sure that the program gives the correct output and marks & White box testing & Each algorithm will be tested once it is developed \\ \hline
