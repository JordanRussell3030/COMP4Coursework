...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:/git/COMP4Coursework2/Analysis/er_diagram.png}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:/git/COMP4Coursework2/Maintenance/task_db.png}
    \label{fig:print_function_result}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:/git/COMP4Coursework2/Maintenance/q_one_db.png}
    \label{fig:print_function_result}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:/git/COMP4Coursework2/Maintenance/q_two_db.png}
    \label{fig:print_function_result}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:/git/COMP4Coursework2/Maintenance/q_three_db.png}
    \label{fig:print_function_result}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:/git/COMP4Coursework2/Maintenance/q_four_db.png}
    \label{fig:print_function_result}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:/git/COMP4Coursework2/Maintenance/all_db.png}
    \label{fig:print_function_result}
\end{figure}
...
1 - The variable representing the number of attempts the user has left is passed through - This is so that the number doesn't reset if one of the other five methods for the other buttons is run (couldn't be subclassed) and it isn't in the method itself as that would effectively require it to be reset with every click.
...
\begin{itemize}
	\item {$https://www.python.org/community/logos/ - Python Powered Logo - First Screen$}
	\item {$https://www.mathsisfun.com/pythagoras.html - Pythagoras Picture - Home Screen$}
	\item {$http://mathinsight.org/vector_introduction - Vector Picture - Home Screen$}
	\item {$http://www.clipartpanda.com/categories/green-smiley-face-png - Green Face - Home Screen$}
	\item {$https://commons.wikimedia.org/wiki/File:Triangle_model_of_love.png - 1st Triangle - Lesson Topic Menu$}
	\item {$https://en.wikipedia.org/wiki/Equilateral_triangle - 2nd Triangle - Lesson Topic Menu$}
	\item {$http://www.bbc.co.uk/bitesize/standard/maths_i/measure/pythagoras/revision/1/ - 3rd Triangle - Lesson Topic Menu$}
	\item {$https://en.wikipedia.org/wiki/Triangle_inequality - 4th Triangle - Lesson Topic Menu$}
	\item {$https://en.wikipedia.org/wiki/Equilateral_triangle - 5th Triangle - Lesson Topic Menu$}
	\item {$http://passyworldofmathematics.com/trigonometric-ratios/ - 1st Picture - Trigonometry 1 Lesson Menu$}
	\item {$https://www.mathsisfun.com/algebra/sohcahtoa.html - 2nd Picture - Trigonometry 1 Lesson Menu$}
	\item {$http://www.derivativesinvesting.net/article/262371065/trigonometry-finding-unknown-sides/ - SOHCAHTOA Lesson Page 2$}
	\item {$http://maths.nayland.school.nz/Year_11/AS1.7_Triangles/3_trig_angle.htm - 1st Picture - Trigonometry 2 Lesson Menu$}
	\item {$http://revisionmaths.com/gcse-maths-revision/trigonometry/pythagorass-theorem 2nd Picture - Trigonometry 2 Lesson Menu$}
	\item {$http://www.pbs.org/wgbh/nova/proof/puzzle/theoremsans.html - 1st Picture - Pythagoras Lesson Menu$}
	\item {$http://www.bbc.co.uk/schools/gcsebitesize/maths/geometry/pythagoras3drev1.shtml - 2nd Picture - Pythagoras Lesson Menu$}
	\item {$http://www.kshitij-iitjee.com/Adding-Vectors-Subtracting-Vectors-equality-of-vectors - 1st Picture - Vectors Lesson Menu$}
	\item {$http://www.maths.usyd.edu.au/u/MOW/vectors/vectors-3/v-3-3.html - 2nd Picture - Vectors Lesson Menu$}
	\item {$https://en.wikipedia.org/wiki/Triangle - 1st Picture - Summary Lesson Menu$}
	\item {$http://solvemymaths.com/2015/01/27/complements-7-the-pythagorean-theorem/ - 2nd Picture - Summary Lesson Menu$}
	\item {$http://stackoverflow.com/questions/18874339/deform-a-triangle-along-vector-to-get-a-specific-angle - 3rd Picture - Summary Lesson Menu$}
	\item {$http://www.wikihow.com/Remember-the-Trigonometric-Table - 1st Picture - Homework Topic Menu$}
	\item {$http://www.mathsaccelerator.com/measurement/trigonometry-cosine-rule - 2nd Picture - Homework Topic Menu$}
	\item {$https://en.wikipedia.org/wiki/Pythagorean_theorem - 3rd Picture - Homework Topic Menu$}
	\item {$https://www.math.hmc.edu/calculus/tutorials/vectoranalysis/ - 4th Picture - Homework Topic Menu$}
	\item {$http://www.cafepress.co.uk/mf/30421745/i-love-trigonometry_golf-shirt - 5th Picture - Homework Topic Menu$}
	\item {$https://images.google.com/ - Unknown website - 1st Picture - Trigonometry 1 Homework Menu$}
	\item {$https://images.google.com/ - Unknown website - 2nd Picture - Trigonometry 1 Homework Menu$}
	\item {$https://images.google.com/ - Unknown website - 3rd Picture - Trigonometry 1 Homework Menu$}
	\item {$http://passyworldofmathematics.com/lessons/page/5/ - 4th Picture - Trigonometry 1 Homework Menu$}
	\item {$http://passyworldofmathematics.com/lessons/page/5/ - 5th Picture - Trigonometry 1 Homework Menu$}
	\item {$http://passyworldofmathematics.com/lessons/page/5/ - 6th Picture - Trigonometry 1 Homework Menu$}
	\item {$https://images.google.com/ - Unknown website - 1st Picture - Trigonometry 2 Homework Menu$}
	\item {$https://images.google.com/ - Unknown website - 2nd Picture - Trigonometry 2 Homework Menu$}
	\item {$https://images.google.com/ - Unknown website - 3rd Picture - Trigonometry 2 Homework Menu$}
	\item {$https://triglaws.wordpress.com/2011/03/08/problem-1-estimate-the-elevation/ - 4th Picture - Trigonometry 2 Homework Menu$}
	\item {$http://math.tutorcircle.com/geometry/right-triangle.html - 5th Picture - Trigonometry 2 Homework Menu$}
	\item {$http://www.glogster.com/meredithgoh/emaths-project-trigonometry/g-6mshrggqu3136b3go4lu9a0 - 6th Picture - Trigonometry 2 Homework Menu$}
	\item {$http://www.bbc.co.uk/education/guides/zfbqtfr/revision/3 - 1st Picture - Pythagoras Homework Menu$}
	\item {$http://cribbd.com/question/how-do-i-use-trig-in-3d - 2nd Picture - Pythagoras Homework Menu$}
	\item {$http://maths.nayland.school.nz/Year_11/AS1.7_Triangles/4_trig_apps.htm$}
\end{itemize}
